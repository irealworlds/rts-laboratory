...
public class Controller extends Thread{
    ...
    public void init(P_user p_i1, Ps_user p_o1, P_move p2, P_arrived pi2) {
        p1 = new P();
        p1.x = 0;
        this.p2 = p2;
        this.p_i1 = p_i1;
...
class Ps_user extends Semaphore{ // class for user demand and user display
    int x;
    public Ps_user(int permits) {
        super(permits);
    }
}